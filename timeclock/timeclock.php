...
div.clock>button, div#digital>button{
 width:50%;
 height:75px;
 font-size:.6em;
 margin: auto 0px auto 0px;
...
<div class="clock"><button>Clock In</button><button>Clock Out</button></div>
</section>
...
<thead>
 <tr data-row='0'>
        <th colspan="7" id="month" data-offset="" data-length=""> Month </th>
 </tr>
  <tr data-row='0'>
        <th id="Sunday">Sun </th>
        <th id="Monday">Mon </th>
